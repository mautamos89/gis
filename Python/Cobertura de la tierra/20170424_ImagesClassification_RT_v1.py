...
# Description: it runs RT, Classify Raster, Updated Accuracy Assessment Points and Confusion Matrix
# -----------------------------------------------------------------------------------------------------------
...
for a in inputData:
	if a[-3:] <> "pts": # This is used in order to avoid listing point features classes
		...
		print a
		# Run: Train Random Trees Classifier
		arcpy.gp.TrainRandomTreesClassifier_sa(Segmentation, a, outputFileECD, DEM_30m, "50", "30", "0", "COLOR;MEAN;STD;COUNT;COMPACTNESS;RECTANGULARITY")
		print "Done with " + a
